...
static const char *pb_static_strs[] = {
	...
	[IID_CAT_REQUEST_REPLY] = "REQUEST_REPLY",
	[IID_CAT_REQUEST_END] = "REQUEST_END",
	[IID_CAT_REQUEST_CLEAR] = "REQUEST_CLEAR",
	[IID_CAT_REQ_TASK_ENQUEUE] = "REQ_TASK_ENQUEUE",
	[IID_CAT_REQ_TASK_DEQUEUE] = "REQ_TASK_DEQUEUE",
	[IID_CAT_REQ_TASK_COMPLETE] = "REQ_TASK_COMPLETE",
	[IID_CAT_REQ_RPC_REQUEST] = "REQ_RPC_REQUEST",
	[IID_CAT_REQ_RPC_RESPONSE] = "REQ_RPC_RESPONSE",
	...
	[IID_NAME_REQUEST_REPLY] = "REQUEST_REPLY",
	[IID_NAME_REQUEST_END] = "REQUEST_END",
	[IID_NAME_REQUEST_CLEAR] = "REQUEST_CLEAR",
	[IID_NAME_TASK_ENQUEUE] = "TASK_ENQUEUE",
	[IID_NAME_TASK_DEQUEUE] = "TASK_DEQUEUE",
	[IID_NAME_TASK_COMPLETE] = "TASK_COMPLETE",
	[IID_NAME_RPC_RESPONSE] = "RPC_RESPONSE",
...
static void emit_metadata(struct wpb_writer *writer, struct wprof_data_hdr *hdr)
{
	...
	for (u64 i = 0; i < hdr->extra_cnt; i++) {
		...
		if (e->kind == WEXTRA_METADATA || e->kind == WEXTRA_STATS ||
			...
			continue;
		attrs[attr_cnt] = (struct wpb_attr) {
			.key = wpb_cstr(sfmt("extras[%02zu]", attr_cnt - extras_start + 1)),
