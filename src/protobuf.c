...
static const char *pb_static_strs[] = {
	...
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_UNKN] = "cudaMemcpy:???",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_HTOD] = "cudaMemcpy:HtoD",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_DTOH] = "cudaMemcmp:DtoH",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_HTOA] = "cudaMemcmp:HtoA",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_ATOH] = "cudaMemcpy:AtoH",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_ATOA] = "cudaMemcpy:AtoA",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_ATOD] = "cudaMemcpy:AtoD",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_DTOA] = "cudaMemcpy:DtoA",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_DTOD] = "cudaMemcpy:DtoD",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_HTOH] = "cudaMemcpy:HtoH",
	[IID_NAME_CUDA_MEMCPY + CUDA_MEMCPY_PTOP] = "cudaMemcpy:PtoP",
	...
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_HTOD] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_DTOH] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_HTOA] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_ATOH] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_ATOA] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_ATOD] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_DTOA] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_DTOD] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_HTOH] = "",
	[IID_ANNV_CUDA_MEMCPY_KIND + CUDA_MEMCPY_PTOP] = "",
