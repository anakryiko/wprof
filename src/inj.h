...
/* One event chunk: its file plus the accounting reported to wprof at hand-off. */
struct chunk {
	FILE *f;
	u64 byte_sz;
	u64 event_cnt;
...
/*
 * Per-feature event-stream writer. In flight-recorder mode (run_ctx->fr_chunk_size
